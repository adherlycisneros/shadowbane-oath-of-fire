const rooms = [
  ...
  },
  {
    ...
    type: "combat",
    text: "Two Displacer Beasts materialize from the shadows, their forms flickering like illusions. Tentacles poised and eyes gleaming with hunger, they move as one, stalking the cooridor.",
  },
  {
    id: 4, 
  ...
  },
  {
    ...
    type: "puzzle",
    text: "A giant disembodied brain pulses with psychic energy. It demands a phrase whispered long ago. Fail, and your forms shall be... altered.",
  },
  {
    id: 6,
    name: "Sanctum of Reckoning",
    type: "final",
    text: "The final chamber. The air thickens with arcane pressure. Floating above the treasure, a Beholder. Ancient and deranged, it glares at you with its central eye. It won't let you claim the prize without a fight.",
  },
];
